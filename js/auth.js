...
class Auth {
    ...
    static async staffLogin(staffId, password) {
        try {
            ...
            const response = await fetch('https://sdaw.onrender.com/api/staff/login', {
                method: 'POST',
                headers: {
    ...
    static async getUserOrders(userId) {
        try {
            ...
            const response = await fetch(`https://sdaw.onrender.com/api/orders/${userId}`);
            if (response.ok) {
    ...
    static async updateOrderPaymentDetails(userId, orderIndex, paymentUpdates) {
        try {
            ...
            if (orders[orderIndex] && orders[orderIndex]._id) {
                ...
                const response = await fetch(`https://sdaw.onrender.com/api/orders/${orders[orderIndex]._id}/payment`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    static async checkout(paymentDetails = {}) {
        ...
        try {
            ...
            const response = await fetch('https://sdaw.onrender.com/api/orders', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    static async migrateLocalStorageOrders() {
        try {
            ...
            const response = await fetch('https://sdaw.onrender.com/api/orders/migrate', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    static async getUserAddressesFromDB(userId) {
        try {
            const response = await fetch(`https://sdaw.onrender.com/api/user-addresses?userId=${userId}`);
